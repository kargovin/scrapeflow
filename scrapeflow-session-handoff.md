...
- **Phase 3 in progress — Steps 1–10 done, Step 11 is next**
...
**Step 11 — Migration 3.8** (`docs/project/PHASE3_BACKLOG.md` §Step 11):
- Create `user_quotas` table (PRD-012)
- Autogenerate handles after adding `UserQuota` SQLAlchemy model

Steps 12–13 are the remaining schema migrations. Step 12 is hand-written (DB trigger).
