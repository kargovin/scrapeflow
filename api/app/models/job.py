...
class Job(Base):
    ...
    output_format: Mapped[OutputFormat] = mapped_column(Enum(OutputFormat), nullable=False, default=OutputFormat.html)
    result_path: Mapped[str | None] = mapped_column(nullable=True)  # MinIO object path, set when job completes
