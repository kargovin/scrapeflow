...
>
> **Last restructured:** 2026-07-17 · **Last updated:** 2026-07-28 (**P4 / BUG-002 CLOSED + deployed** — `b9c8a1a` Go x/crypto + `e8726bf` Python incl. forced clerk 5→6 + `b110591` frontend; **8 crit / 13 high → 0 crit / 0 high**, login smoke-tested. **Next: P5 (Q1–Q4 close-out, bookkeeping).** `develop` and `main` level at `b110591` and deployed. 47 medium/low Dependabot alerts remain, deferred to §4.)
