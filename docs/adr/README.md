...
| [ADR-011](ADR-011-artifact-identity-and-paths.md) | Artifact Identity — Run-keyed Paths, Stage-named Objects, and the Removal of `latest/` | **Draft** | 2026-09-03 | ADR-002 §4 *(on acceptance)* | — |
