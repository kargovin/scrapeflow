    ...
    <Routes>
      <Route element={<RequireSignedIn />}>
        ...
        <Route element={<RequireAdmin />}>
          <Route element={<Layout navItems={ADMIN_NAV} title="ScrapeFlow Admin" />}>
            <Route path="/app/admin" element={<Navigate to="/app/admin/users" replace />} />
            <Route path="/app/admin/users" element={<Users />} />
            <Route path="/app/admin/jobs" element={<Jobs />} />
            <Route path="/app/admin/jobs/:jobId" element={<JobDetail />} />
            <Route path="/app/admin/stats" element={<UsageStats />} />
          </Route>
        </Route>

        {/* User dashboard — available to all signed-in users */}
        <Route element={<Layout navItems={USER_NAV} title="ScrapeFlow" />}>
          <Route path="/app/dashboard" element={<Navigate to="/app/dashboard/api-keys" replace />} />
